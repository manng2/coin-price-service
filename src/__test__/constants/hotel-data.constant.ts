import { UncleanedHotelDataModel, HotelDataBySupplierModel, AmenitiesNameModel } from '../../models';
...
const uncleanedMockData2: UncleanedHotelDataModel = {
  ...
  amenities: [AmenitiesNameModel.BREAKFAST, AmenitiesNameModel.BAR, AmenitiesNameModel.BATHTUB],
  images: {
    room: [
      {
        url: 'URL 2',
...
const uncleanedMockDataMerging1_1: UncleanedHotelDataModel = {
  ...
  amenities: [AmenitiesNameModel.BREAKFAST, AmenitiesNameModel.BAR, AmenitiesNameModel.BATHTUB, AmenitiesNameModel.BUSINESS_CENTER],
  images: {
    room: [
      {
        url: 'URL 2',
